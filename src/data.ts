   // All cons
export const initials = ['b', 'p', 'm', 'd', 't', 'n', 'l', 'g', 'k', 'ng', 'h', 'c', 'ch', 's'];

    // All vowel combinations
    // @todo: 未區分韻尾
    // 每行一個韻母
    // 根據閩英第三版 xviii-xix 頁 Table III 校對
...
export const finals =
  ...
  /*秋*/     'iu': ['iŭ',   'iū',  'éu',   'éuh',  'iù',   'êu',   'iŭh'],
  /*山*/    'ang': ['ăng',  'āng', 'áng',  'ák',   'àng',  'âng',  'ăk'],
